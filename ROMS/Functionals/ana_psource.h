...
#  endif
#  ifdef REEF_ECOSYS
              SOURCES(ng)%Tsrc(is,k,iTIC_)=3000.0_r8
              SOURCES(ng)%Tsrc(is,k,iTAlk)=3000.0_r8
              SOURCES(ng)%Tsrc(is,k,iOxyg)=10.0_r8/0.02241_r8
#   ifdef CARBON_ISOTOPE
              SOURCES(ng)%Tsrc(is,k,iT13C)=R13C_fromd13C( 0.0_r8 )* &
      &                                    SOURCES(ng)%Tsrc(is,k,iTIC_)
#   endif
#   ifdef NUTRIENTS
              SOURCES(ng)%Tsrc(is,k,iNO3_)=100.0_r8
              SOURCES(ng)%Tsrc(is,k,iNH4_)=0.5_r8
              SOURCES(ng)%Tsrc(is,k,iChlo)=0.0_r8
              SOURCES(ng)%Tsrc(is,k,iPhyt)=0.0_r8
              SOURCES(ng)%Tsrc(is,k,iZoop)=0.0_r8
              SOURCES(ng)%Tsrc(is,k,iLDeN)=0.1_r8
              SOURCES(ng)%Tsrc(is,k,iSDeN)=0.1_r8
              SOURCES(ng)%Tsrc(is,k,iLDeC)=0.01_r8
              SOURCES(ng)%Tsrc(is,k,iSDeC)=0.1_r8
#   endif
#  endif
            END DO
          END DO
